...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CaliphCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1.net","213.252.245.164"},
    {"node2.net","213.252.245.142"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CaliphCoin is probably already running."), addrBind.ToString().c_str());
        else

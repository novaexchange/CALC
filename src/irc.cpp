...
// Copyright (c) 2011-2012 CaliphCoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("CaliphCoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #CaliphCoin2TEST0\r");
            Send(hSocket, "WHO #CaliphCoin2TEST0\r");
        } else {
            // randomly join #CaliphCoin200-#CaliphCoin299
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #CaliphCoin2%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #CaliphCoin2%02d\r", channel_number).c_str());
        }
